...
- **9:00-?** Our last lecture session
- **1:30-3:00ish** (optional): 301 Final Presentations!
	- Try to catch at least a couple of them!
	- See what final 301 projects look like and what all is happening in them!
...
`(10-minute breaks between the above segments as needed)`
